...
{
    /// <summary>
    /// A send email class. Compliance to all email client for Windows has mapi32.dll to be installed.
    /// Mapi32.dll is the sendmail library for Microsoft.
    /// TODO: Ensure all client must have mininum mapi32.dll installed?
    /// </summary>
    /// <remarks>
    /// Thanks to David M Brooks from CodeProject.
    /// <example>
    /// <code>
    /// MAPI mapi = new MAPI();
    ...
    /// </example>
    /// </remarks>
    /// <see>http://www.codeproject.com/KB/IP/SendFileToNET.aspx</see>
    /// <see>http://www.codeproject.com/script/Articles/MemberArticles.aspx?amid=107134</see>
    /// <see>http://www.codeproject.com/info/cpol10.aspx</see>
    /// <seealso>http://www.ietf.org/rfc/rfc2368.txt</seealso>
    class Mapi
    {
