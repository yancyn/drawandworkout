...
namespace WorkOrderGUI
{
    ...
    /// <summary>
    /// Extend log4net.Util.PatternString to support SpecilFolder e.g. ApplicationData.
    /// </summary>
    /// <remarks>No use temporarily.</remarks>
    /// <see>http://cowarthill.com/blog/index.php/2009/12/23/log4net-patternstring/</see>
    public class SpecialFolderPathConverter : log4net.Util.PatternConverter
    {
        protected override void Convert(System.IO.TextWriter writer, object state)
        {
            if (String.IsNullOrEmpty(this.Option)) return;
